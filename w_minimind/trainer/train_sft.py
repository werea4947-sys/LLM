...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MyMind Pretraining")
    ...
    parser.add_argument(
        "--save_weight", default="sft", type=str, help="保存权重的前缀名"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default="../dataset/sft_mini_512.jsonl",  # ！修正：原"dataset/..."缺少../前缀
        help="预训练数据路径",
    )
    parser.add_argument(
        "--from_weight",
